...
<div class="bg-wrapper">
        ...
        <div class="container">
          ...
          <div class="index-service__box">
            <div class="service-slider swiper-container">
              <ul class="service-list swiper-wrapper">
                <li class="secrive-list__item swiper-slide">
                  <a href="#" class="service-list__inner">
                    <div class="service-list__image">
                      <picture>
                        ...
                        <img width="175" height="297" src="<?php echo get_template_directory_uri();?>/img/services/img.png" alt="image">
                      </picture>
                    </div>
                ...
                <li class="secrive-list__item swiper-slide">
                  <a href="#" class="service-list__inner">
                    <div class="service-list__image">
                      <picture>
                        <source type="image/webp" media="(max-width: 575px)" srcset="<?php echo get_template_directory_uri();?>/img/services/mobile2.webp">
                        <source media="(max-width: 575px)" width="251" height="182" srcset="<?php echo get_template_directory_uri();?>/img/services/mobile2.png">
                        <source type="image/webp" srcset="<?php echo get_template_directory_uri();?>/img/services/img2.webp">
                        <img width="175" height="297" src="<?php echo get_template_directory_uri();?>/img/services/img2.png" alt="image">
                      </picture>
                    </div>
                    <div class="service-list__descr">
                      <span class="service-list__title">
            ...
            <div class="index-service__bottom">
              ...
              <a href="#" class="index-service__button green-btn">
                ВСЕ УСЛУГИ
              </a>
                ...
                <li class="medic-list__item swiper-slide">
                  <div class="medic-list__inner">
                    <div class="medic-list__image">
                      <picture>
                        <source type="image/webp" srcset="<?php echo get_template_directory_uri();?>/img/doctor.webp">
                        <img width="186" height="205" src="<?php echo get_template_directory_uri();?>/img/doctor.png" alt="image">
                      </picture>
                    </div>
        ...
        <div class="container">
          <div class="index-about__box">
            <article class="index-about__article">
              <h2 class="index-about__title gradient-title">
                О КЛИНИКЕ
              </h2>
            ...
            <div class="index-about__wrapper">
              <div class="about-slider swiper-container">
                <ul class="about-slider__list swiper-wrapper">
                  <li class="about-slider__slide swiper-slide">
                    <a href="#" class="about-slider__link">
                      <picture>
                        <source type="image/webp" srcset="<?php echo get_template_directory_uri();?>/img/slider/img.webp">
                        <img width="226" height="335" src="<?php echo get_template_directory_uri();?>/img/slider/img.png" alt="image">
                      </picture>
                    </a>
                  </li>
                  ...
                  <li class="about-slider__slide swiper-slide">
                    <a href="#" class="about-slider__link">
                      <picture>
                        <source type="image/webp" srcset="<?php echo get_template_directory_uri();?>/img/slider/img2.webp">
                        <img width="226" height="335" src="<?php echo get_template_directory_uri();?>/img/slider/img2.png" alt="image">
                      </picture>
                    </a>
                  </li>
              ...
              <div class="index-about__bottom">
                <a href="#" class="index-about__button green-btn">
                  подробнее
                </a>
                <nav class="slider-nav">
  ...
  <div class="container">
    <span class="big-title gradient-title">
      IMPLANT CENTER
    </span>

    <div class="pas-section__box">
      <h2 class="pas-section__title gradient-title">
        НАШИ ПРЕИМУЩЕСТВА
      </h2>

      <ul class="pas-list">
        <li class="pas-list__item">
          У нас всегда царит доброжелательная и успокаивающая атмосфера. Мы действительно лечим «без страха и боли», используя самые современные методики.
        </li>
        <li class="pas-list__item">
          Специалисты клиники после осмотра составляют оптимальный план лечения, исключающий дополнительные процедуры и траты.
        </li>
        <li class="pas-list__item">
          Мы индивидуально подходим к каждому пациенту и предлагаем максимально доступные условия + расширенные гарантии.
        </li>
        <li class="pas-list__item">
          Дисконтная программа ToDay предусматривает хорошие семейные и корпоративные скидки, выгодные условия для постоянных клиентов.
        </li>
      </ul>
    </div>
      ...
      <section class="our-find">
        <div class="container">
          <div class="main-top">
            <h2 class="main-top__title gradient-title our-find__title">
              КАК НАС НАЙТИ
            </h2>
          ...
          <div class="our-find__box">
            ...
            <div class="find-contact">
              <a href="index.html" class="find-contact__logo">
                <picture>
                  <source type="image/webp" srcset="<?php echo get_template_directory_uri();?>/img/logo.webp">
                  <img width="47" height="44" src="<?php echo get_template_directory_uri();?>/img/logo.png" alt="logo">
                </picture>
              ...
              <ul class="find-contact__list">
                <li class="find-contact__item">
                  ...
                  <a href="https://goo.gl/maps/TvwkEB5V7MTrSUxx8" class="find-contact__link">
                    ул. Асхарова, 13
                  </a>
                </li>
                ...
                <li class="find-contact__item">
                  ...
                  <a href="tel:+080036585" class="find-contact__link">
                    + 0 800 365 85
                  </a>
                  <a href="tel:+080036585" class="find-contact__link">
                    + 0 800 365 85
              ...
              <ul class="find-social">
                <li class="find-social__item">
                  <a href="#" class="find-social__link">
                    <picture>
                      <source type="image/webp" srcset="<?php echo get_template_directory_uri();?>/img/insta.webp">
                      <img width="40" height="40" src="<?php echo get_template_directory_uri();?>/img/insta.png" alt="instagram">
                    </picture>
                  </a>
                </li>
                <li class="find-social__item">
                  <a href="#" class="find-social__link">
                    <picture>
                      <source type="image/webp" srcset="<?php echo get_template_directory_uri();?>/img/fb.webp">
                      <img width="40" height="40" src="<?php echo get_template_directory_uri();?>/img/fb.png" alt="facebok">
                    </picture>
                  </a>
                </li>
                <li class="find-social__item">
                  <a href="#" class="find-social__link">
                    <picture>
                      <source type="image/webp" srcset="<?php echo get_template_directory_uri();?>/img/viber.webp">
                      <img width="40" height="40" src="<?php echo get_template_directory_uri();?>/img/viber.png" alt="viber">
                    </picture>
                  </a>
                </li>
                <li class="find-social__item">
                  <a href="#" class="find-social__link">
                    <picture>
                      <source type="image/webp" srcset="<?php echo get_template_directory_uri();?>/img/telega.webp">
                      <img width="40" height="40" src="<?php echo get_template_directory_uri();?>/img/telega.png" alt="telegram">
                    </picture>
                  </a>
                </li>
              </ul>
  ...
  <div class="container">
    <div class="main-top">
      <h2 class="main-top__title form-section__title">
        ОСТАЛИСЬ ВОПРОСЫ?
      </h2>

      <p class="main-top__text form-section__text">
        Целостность зубного ряда важна не только с точки зрения эстетичного внешнего вида и красивой улыбки.
      </p>
    </div>
    ...
    <div class="form-section__box">
      <form action="#" class="main-form">
        ...
        <button class="main-form__button green-btn">
          ЗАПИСАТЬСЯ
        </button>
      </form>
    </div>
